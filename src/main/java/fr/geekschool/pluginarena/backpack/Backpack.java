package fr.geekschool.pluginarena.backpack;


import fr.geekschool.pluginarena.utils.Base64;
...
public class Backpack {
    ...
    public Backpack(UUID uuid) {
        this.uuid = uuid;
        this.inventory = Bukkit.createInventory(null, 27, "§4Christmas §1Hotte");
    }
