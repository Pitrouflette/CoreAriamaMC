...
public class ArmureUpUnbreaking implements CommandExecutor{
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (playerHandMeta.hasEnchant(Enchantment.DURABILITY)){
            ...
            playerHandMeta.addEnchant(Enchantment.DURABILITY, 10, true);
            playerHandMeta.addItemFlags(ItemFlag.HIDE_ENCHANTS);
            playerHandMeta.setLore(Arrays.asList("§7unbreaking §4X"));
